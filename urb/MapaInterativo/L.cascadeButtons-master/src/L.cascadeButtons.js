L.Control.cascadeButtons = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    this._buttons.forEach((button) => {
      ...
      const icon = L.DomUtil.create("img", `addlayericon`);
      icon.setAttribute("src", "https://urbanlogics.com.br/urb/MapaInterativo/L.cascadeButtons-master/src/noun-layer-add-667516.png");
      mainButton.setAttribute("type", "button");
      mainButton.setAttribute("aria-expanded", "false");
      mainButton.setAttribute("id", "buttonlayered");

      container.append(mainButton);
       mainButton.append(icon);
