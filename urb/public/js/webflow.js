 ...
 */ !(function (t) {
      ...
      var f = (function (t, e, n) {
        ...
        C = function (t) {
          ...
          for (e = 0; e < R.length; e++)
            if ((n = R[e] + r) in b.style) return { dom: n, css: N[e] + t };
        },
        L = (e.support = {
  ...
  function (t, e, n) {
    ...
    function At(t, e) {
      ...
      var n = t.elementId,
        ...
        o = i.ref;
      i.refType === R && Q(o, r, T), e.dispatch((0, I.instanceRemoved)(t.id));
    }
    function St(t, e, n) {
      ...
      (t.exports = function (t, e) {
        ...
        function m() {
          !(function () {
            ...
            e.each(S),
              e.each(O),
              h.length && (r.scroll.on(w), setTimeout(w, 1));
            _.length && r.load(b);
        ...
        function w() {
          for (
            var t = u.scrollTop(), e = u.height(), n = h.length, r = 0;
            r < n;
            r++
          ) {
            var i = h[r],
        ...
        function N(e, r, i, o) {
          ...
          if (!n || i.force) {
            ...
            if (p && p.length) {
              ...
              for (var E = s(r), h = { omit3d: !u }, _ = 0; _ < p.length; _++)
                C(E, p[_], h);
              h.start ? E.then(g) : g();
            }
          }
          function g() {
            ...
            "auto" === h.width && E.set({ width: "auto" }),
              "auto" === h.height && E.set({ height: "auto" }),
              a && a();
          }
        }
        function C(t, e, n) {
  ...
  function (t, e, n) {
                ...
                case T.STYLE_TEXT_COLOR:
                  ...
                  X(t, _, o),
                    a(
                      ...
                      _,
                      A >= 1
                        ? "rgb(".concat(I, ",").concat(y, ",").concat(m, ")")
                        : "rgba("
                            .concat(I, ",")
                            .concat(y, ",")
                            .concat(m, ",")
    ...
    function C(t) {
      ...
      if (
        (D
          ? ((R = x.limitAffectedElements), (C = P), (L = u(x)))
          : (C = L = u({ id: _, selector: m, selectorGuids: O })),
        n && w)
      ) {
        var M = r && (L || !0 === w) ? [r] : c(P);
        if (L) {
        ...
        (0, o.default)(r, D, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              { elementHovered: w, clientX: v, clientY: _, pageX: I, pageY: y }
            );
          },
        }),
        (0, o.default)(r, H, {
                    ...
                    switch (e.keyCode) {
                      ...
                      case o.ARROW_DOWN:
                        return (
                          ...
                          void (
                            t.selectedIdx >= 0 &&
                            (t.open || (t.selectedIdx = 0), A(t), w(t))
                          )
                        );
                      case o.ARROW_UP:
                        return (
...
Webflow.require("ix").init([
  ...
  {
    slug: "abre-fecha-resposta",
    name: "Abre Fecha Resposta",
    value: {
      style: {},
      triggers: [
        {
  ...
  {
    slug: "abre-fecha-classe",
    name: "Abre Fecha Classe",
    value: {
      style: { x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".classe-texto-1",
          descend: true,
          preserve3d: true,
          stepsA: [
            {
        ...
        {
          type: "click",
          selector: ".botao-fecha-classe-copy",
          descend: true,
          stepsA: [{ display: "flex" }],
          stepsB: [{ display: "none" }],
        },
  ...
  },
  {
    slug: "hide-in-open",
    name: "Hide in open",
    value: { style: { title: "Hide", display: "none" }, triggers: [] },
  },
  {
    slug: "desliga-botao",
    name: "Desliga botao",
    value: {
      style: {},
      triggers: [{ type: "click", stepsA: [{}], stepsB: [] }],
    },
  },
  {
    slug: "uso-especial",
    name: "Uso especial",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".uso-especial-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "interesse-comunitario",
    name: "Interesse comunitario",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".interesse-comunitario-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "nao-classificados",
    name: "Nao classificados",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".nao-classificados-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "arpub-vegetacao-relevante",
    name: "ArPub Vegetacao Relevante",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".arpub-vegetacao-relevante-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "esportivas-abertas",
    name: "Esportivas Abertas",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".esportivas-abertas-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  },
  {
    ...
    value: {
      ...
      triggers: [
        {
          type: "click",
          selector: ".parques-lineares-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "grandes-aterros",
    name: "grandes aterros",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".grandes-aterros-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  },
  {
    ...
    value: {
      ...
      triggers: [
        {
          type: "click",
          selector: ".parques-urbanos-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "areas-naturais-tombadas",
    name: "Areas naturais tombadas",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".ar-nat-tombadas-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "contemplacao-orla",
    name: "Contemplacao orla",
    value: {
      style: { display: "block", x: "0px", y: "0px", z: "0px" },
      triggers: [
        {
          type: "click",
          selector: ".contemplacao-orla-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  },
  {
    ...
    value: {
      ...
      triggers: [
        {
          type: "click",
          selector: ".unid-conservacao-texto",
          stepsA: [{ display: "block" }],
          stepsB: [{ display: "none" }],
        },
        {
  ...
  {
    slug: "show-empreendimento",
    name: "SHOW EMPREENDIMENTO",
    value: {
      style: {},
      triggers: [
        {
          type: "click",
          selector: ".div-empreendimento",
          stepsA: [
        ...
        {
          type: "click",
          selector: ".div-deposito",
          stepsA: [
            {
              display: "block",
              opacity: 0,
              height: "0px",
              transition: "height 2000ms ease 0, opacity 500ms ease 0",
            },
            { display: "none" },
          ],
          stepsB: [],
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c5e|8b267e2c-29bc-1ba0-1a07-b938587d6143",
                },
                value: 0.49,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c5e|18934bd3-7e10-63f8-1600-581c2a54c12e",
                },
                xValue: 500,
                xUnit: "PX",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c80|8b267e2c-29bc-1ba0-1a07-b938587d6143",
                },
                value: 0.49,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c80|18934bd3-7e10-63f8-1600-581c2a54c12e",
                },
                xValue: 500,
                xUnit: "PX",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8cb9|8b267e2c-29bc-1ba0-1a07-b938587d6143",
                },
                value: 0.49,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8cb9|18934bd3-7e10-63f8-1600-581c2a54c12e",
                },
                xValue: 500,
                xUnit: "PX",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c68|8b267e2c-29bc-1ba0-1a07-b938587d6143",
                },
                value: 0.49,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c68|18934bd3-7e10-63f8-1600-581c2a54c12e",
                },
                xValue: 500,
                xUnit: "PX",
                yUnit: "PX",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c93|8b267e2c-29bc-1ba0-1a07-b938587d6143",
                },
                value: 0.49,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "5a9887217bd2b100011e8c93|18934bd3-7e10-63f8-1600-581c2a54c12e",
                },
                xValue: 500,
                xUnit: "PX",
                yUnit: "PX",
